export default {
  ...
  login: {
    ...
    passwordSectionRule: 'The password can only be between 6 and 15 digits',
    desc: `
  ...
  route: {
    ...
    home: 'Home',
    demo: 'Demo Component',
    'base-icon': 'Icon Select',
    'area-cascade': 'Cascade selector',
  ...
  profile: {
    ...
    Introduction:
      'A light seeker dedicated to front-end architecture technology...',
  },
  userInfo: {
    print: 'Print',
