/*
 * @Author: ChenYu
 * @Date: 2022-03-20 23:28:35
 * @LastEditors: ChenYu
 * @LastEditTime: 2022-03-21 23:47:22
 * @FilePath: \v3-el-components\src\components\C_Form\types\rule.ts
 * @Description: async-validator interface.ts
...
export interface RuleItem {
  ...
  validator?: (
    ...
    source: Values,
    options: ValidateOption
  ) => SyncValidateResult | void | Promise<void>
}
