...
export const featureData = [
  ...
  },
  {
    ...
    percentage: 100,
    content:
      '一个后台前端解决方案，它基于 vue 和 element-plus实现，本项目使用最新 vue 技术对其进行了重构，并在其现有功能上进行了扩展，致力于为大家带来更加符合 <b>现代后台开发的前端技术解决方案</b>',
  },
  {
  ...
  },
  {
    ...
    percentage: 100,
    content:
      '除了以上功能之外，还实现了很多其他的功能，比如：CDN、动态的环境变量配置、懒加载、跨域等等',
  },
]
