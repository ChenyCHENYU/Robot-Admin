<template>
  <div class="dragable-container">
    ...
    <ElRow>
      <ElRow>
        <ElCol>
          <ElButton type="success">Add New</ElButton>
        </ElCol>
      </ElRow>
      <ElCol :span="24">
        <div class="board">
          <div class="task">
            ...
            <div ref="todoRef" class="task-list-item">
              <ElCard
                v-for="item in task.todoList"
                :key="item.id"
                shadow="hover"
                class="card"
              >
                <ElRow>
                  <ElCol :span="24" style="text-align: left">
                    ...
                    <div class="flex flex-row flex-between">
                      <div class="flex flex-row flex-start align-center">
                        <ElAvatar size="small" :src="item.avatar"></ElAvatar>
          ...
          <div class="task">
            <h5 class="task-header text-upercase margin-top-0">
              In Progress (2)
            </h5>
              ...
              <ElCard shadow="hover" class="card">
                <ElRow>
                  <ElCol :span="24" style="text-align: left">
                    ...
                    <p class="text-muted margin-bottom-1">
                      <span class="text-norap margin-right-1"
                        ><el-icon><ElIconSuitcase /></el-icon> web</span
                      >
                      <span class="text-norap margin-right-1"
                        ><el-icon><ElIconChatLineSquare /></el-icon> 28
                        Comments</span
                      >
                    </p>
                    <div class="flex flex-row flex-between">
              ...
              <ElCard shadow="hover" class="card">
                <ElRow>
                  <ElCol :span="24" style="text-align: left">
                    ...
                    <h5 class="margin-top-1 margin-bottom-1">
                      draggable design width sortable
                    </h5>
                    <p class="text-muted margin-bottom-1">
                      <span class="text-norap margin-right-1">
                        <ElIconSuitcase />
...
const task = reactive<I_TaskType>({
  todoList: [
    {
      id: 1,
      priority: 2,
...
const taskRef = reactive<I_TaskRefType>({})
