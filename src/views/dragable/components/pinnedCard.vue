<template>
  <div class="pinned-container">
    <div ref="cardRef" class="card-container">
      <div v-for="card in state.cardInfo" :key="card.id" class="card">
        <ElCard shadow="hover" style="width: 100%; min-height: 154px">
          <div class="top-container">
            <div class="card-title">
              <img :src="card.imgSrc" class="title-logo" />
              <span class="title-name" @click="handleLinkClick(card.link)">
                {{ card.cardTitle }}
              </span>
            </div>
            <ElTooltip
...
const state = reactive<I_CardInfoType>({
  cardInfo: [
    {
      id: 1,
      imgSrc:
...

    {
      ...
      cardContent:
        ' Typescript 是javascript类型的超集，他可以编译为纯javascript',
    },
    {
      id: 3,
      imgSrc:
        'https://camo.githubusercontent.com/4bcb1d37ed894a95286285bafc7238ac534ec75b32c1ceb5693493c9c5061d77/68747470733a2f2f73706f6e736f72732e7675656a732e6f72672f696d616765732f61707077726974652e737667',
      cardTitle: 'vue-next',
...
// 组件卸载时销毁实例
onUnmounted(() => cardSortable.destroy())
</script>
